...
from model_zoo import sparse_bn_feature_net_31x31 as nuclear_fn
...
Load data
"""
direc_name = '/root/ecoli_net/testing_data/video_1'
data_location = os.path.join(direc_name, 'Raw')
nuclear_location = os.path.join(direc_name, 'Nuclear/31x31')
mask_location = os.path.join(direc_name, 'Masks/31x31')

nuclear_channel_names = ['test_vid']

trained_network_nuclear_directory = "/root/NetworkData/ecoli_net/trained_networks/31x31/"

nuclear_prefix = "ecoli_david_31x31_bn_feature_net_"
